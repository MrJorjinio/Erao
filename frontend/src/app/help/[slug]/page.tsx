...
const articles: Record<string, { title: string; category: string; content: string[] }> = {
  ...
  "connection-troubleshooting": {
    ...
    content: [
      ...
      "If issues persist, contact support at support@erao.io.",
    ],
  },
  "effective-questions": {
  ...
  "encryption": {
    ...
    content: [
      ...
      "Regular rotation: Encryption keys are rotated periodically.",
  ...
  "compliance": {
    ...
    category: "Security",
    content: [
      "Erao maintains compliance with industry standards.",
      ...
      "We can provide compliance documentation upon request.",
      "For enterprise compliance requirements, contact sales@erao.io.",
    ],
  },
